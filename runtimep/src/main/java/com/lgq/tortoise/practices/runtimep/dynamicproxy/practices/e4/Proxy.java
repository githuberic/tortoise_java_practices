...
public class Proxy {
    ...
    public static Object newProxyInstance(ClassLoader classLoader, Class intface, InvocationHandler h) {
        try {
            // 1.生成源代码
            String src = generateSrc(intface);
    ...
    private static String generateSrc(Class intfce) {
        ...
        sb.append("package com.lgq.jbasic.proxy.dynamicproxy.example.e4;").append(ln)
