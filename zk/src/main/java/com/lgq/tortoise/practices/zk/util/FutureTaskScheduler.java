...
public class FutureTaskScheduler extends Thread {
     ...
     * 任务队列
     */
    private final ConcurrentLinkedQueue<ExecuteTask> executeTaskQueue = new ConcurrentLinkedQueue<ExecuteTask>();

    private final ExecutorService pool = Executors.newFixedThreadPool(10);

    private static final FutureTaskScheduler SCHEDULER = new FutureTaskScheduler();
